<div class="md:flex gap-x-8 text-black">
    <div class="w-full md:w-1/2">
        <div class="bg-white md:p-8 text-center md:text-left">
            <h3 class="font-bold pb-4 text-trueGray-700 text-base lg:text-lg xl:text-2xl md:uppercase">Possui alguma dúvida?</h3>
            <p class="text-base text-trueGray-700">Preencha nosso formulário ou entre em contato conosco para tirar dúvidas ou falar diretamente com nossa equipe!</p>
        ...
        <div class="text-md md:text-lg md:p-8">
            <div class="text-base lg:text-lg xl:text-2xl pb-4 text-center md:text-left">
                <h3 class="font-bold pb-4 text-trueGray-700 md:uppercase">
                    Será um prazer te atender!</h3>
                <p class="text-base text-trueGray-700">
                    Preencha nosso formulário ou entre em contato para esclarecer suas dúvidas e
                    solicitar um orçamento. Será um prazer atendê-lo!</p>
            </div>
            <a href="<?php echo InfoVar::show('whatsapp'); ?>" target="_blank">
                <div
                    class="flex justify-start items-center px-2 pt-4 pb-6 rounded-lg hover:bg-gray-100 break-all text-black text-base md:text-lg xl:text-xl">
