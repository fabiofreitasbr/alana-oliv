    ...
    <div class="container mx-auto px-4 text-white">
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 lg:text-left pb-6 lg:gap-x-8 text-center lg:place-items-start">
            ...
            <div class="w-full my-4">
                <img src="<?php echo esc_url($logo_white); ?>" alt="Alana Oliveira Logo" class="w-2/3 mx-auto" />
            </div>
            ...
            <div class="my-3">
                ...
                <ul class="text-white flex flex-col items-center lg:items-start text-sm font-normal 2xl:text-lg">
                    <li class="py-2"><a href="<?php echo esc_url(home_url('/')); ?>" class="text-bege-100 hover:text-verde-500">Home</a></li>
                    <li class="py-2"><a href="<?php echo esc_url(home_url('/about')); ?>" class="text-bege-100 hover:text-verde-500">About Me</a></li>
                    <li class="py-2"><a href="<?php echo esc_url(home_url('/services')); ?>" class="text-bege-100 hover:text-verde-500">Services</a></li>
                    <li class="py-2"><a href="<?php echo esc_url(home_url('/contact')); ?>" class="text-bege-100 hover:text-verde-500">Contact</a></li>
                </ul>
            </div>

            <!-- Contacts -->
            <div class="my-3 break-words text-wrap">
                <h3 class="text-white md:mb-2 text-lg md:text-xl font-medium">Contacts</h3>
            ...
            <div class="my-3 md:col-span-3 lg:col-span-1">
                <h3 class="text-white md:mb-2 text-lg md:text-xl font-medium">Social Media</h3>
                ...
                <a href="https://www.agenciakls.com.br/" target="_blank" rel="noopener">
                    <div class="flex justify-center lg:justify-start gap-3 mt-8">
                        ...
                        <img src="<?php echo esc_url($kls_logo); ?>" width="64" height="24" class="w-16" alt="KLS Agency Logo" />
                    </div>
                </a>
            </div>
        </div>
        ...
        <div>
            <p class="text-sm text-verde-100 text-center">
                <span class="text-white">Alana Oliveira</span> – All rights reserved.
            </p>
        </div>
    </div>
</footer>
