        ...
        <div class="flex flex-row justify-between items-center h-auto">
            ...
            <nav class="flex items-center gap-x-4 lg:gap-x-10">
                <ul class="hidden md:flex gap-x-[2rem] lg:gap-x-[2.5rem] xl:gap-x-10 2xl:gap-x-[3rem] text-xs md:text-sm lg:text-base xl:text-lg 2xl:text-2xl font-medium items-center uppercase">
                    <li>
                        <a href="<?php echo get_page_link(4); ?>" class="text-white hover:text-marrom-900 <?php echo ($page_id == 4) ? 'py-4 !text-marrom-900' : ''; ?>">Home</a>
                    </li>
                    <li>
                        <a href="<?php echo get_page_link(7); ?>" class="text-white hover:text-marrom-900 <?php echo ($page_id == 7) ? 'py-4 !text-marrom-900' : ''; ?>">About Me</a>
                    </li>
                    <li>
                        <a href="<?php echo get_page_link(9); ?>" class="text-white hover:text-marrom-900 <?php echo ($page_id == 9) ? 'py-4 !text-marrom-900' : ''; ?>">Services</a>
                    </li>
                    <li>
                        <a href="<?php echo get_page_link(11); ?>" class="text-white hover:text-marrom-900 <?php echo ($page_id == 11) ? 'py-4 !text-marrom-900' : ''; ?>">Contact</a>
                    </li>
                </ul>
                <!-- Dropdown de Idiomas -->
                <div class="relative inline-block text-left">
                    ...
                    <div id="dropdownLanguage" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-32">
                        <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownLanguageButton">
                            <li>
                                <a href="http://alanaoliv.com/" class="block px-4 py-2 hover:bg-gray-100">PT</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<nav class="block md:hidden z-40 w-full h-screen bg-marrom-900 fixed top-0 px-6 pt-28 transition-all duration-300 ease-in-out -right-full" id="header-bar-mobile">
    <div class="container mx-auto">
        <ul class="flex flex-col gap-5 xl:gap-10 text-xl font-medium">
            <li>
                <a href="<?php echo get_page_link(4); ?>" class="text-white <?php echo ($page_id == 4) ? 'border-b-2 py-1 border-marrom-900' : ''; ?>">Home</a>
            </li>
            <li>
                <a href="<?php echo get_page_link(7); ?>" class="text-white <?php echo ($page_id == 7) ? 'border-b-2 py-1 border-marrom-900' : ''; ?>">About Me</a>
            </li>
            <li>
                <a href="<?php echo get_page_link(9); ?>" class="text-white <?php echo ($page_id == 9) ? 'border-b-2 py-1 border-marrom-900' : ''; ?>">Services</a>
            </li>
            <li>
                <a href="<?php echo get_page_link(11); ?>" class="text-white <?php echo ($page_id == 11) ? 'border-b-2 py-1 border-marrom-900' : ''; ?>">Contact</a>
            </li>
        </ul>
    </div>
</nav>
